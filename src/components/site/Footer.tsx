    ...
    <footer className="border-t border-border/70 bg-background/60">
      <div className="mx-auto max-w-[1240px] px-6 py-20">
        <div className="grid gap-14 md:grid-cols-[1.2fr_1fr_1fr]">
          <div>
            <img src={logoSrc} alt="AICA 2026" className="h-24 w-auto object-contain" />
              ...
              {SOCIAL.map(({ label, href, Icon }) => (
                <li key={label}>
                  <a
                    ...
                    aria-label={label}
                    title={label}
                    className="flex h-10 w-10 items-center justify-center border border-border/60 text-muted-foreground transition-all duration-200 hover:border-gold hover:text-gold hover:scale-110"
                  >
                    <Icon />
                  </a>
                </li>
